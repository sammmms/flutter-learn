            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    CircleAvatar(
                        foregroundImage: AssetImage(p.pictureLink), radius: 40),
                    Expanded(
                        flex: 1,
                        child: Row(
