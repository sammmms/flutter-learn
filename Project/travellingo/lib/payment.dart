                    ...
                    children: [
                      ListTile(
                        leading: Icon(Icons.account_balance_wallet,
                            color: Color(0xFF3E84A8)),
                        title: Text('Paylater',
                            style: GoogleFonts.inter(color: Color(0xFF141511))),
                        trailing: Text('Activate Now',
                            style: GoogleFonts.inter(color: Color(0xFF3E84A8))),
                      ),
                      ExpansionTile(
                        leading: Icon(Icons.money, color: Color(0xFF3E84A8)),
                        title: Text('e-Money',
                            style: GoogleFonts.inter(color: Color(0xFF141511))),
                      ...
                      ExpansionTile(
                        leading:
                            Icon(Icons.phone_android, color: Color(0xFF3E84A8)),
                      ...
                      ExpansionTile(
                        leading:
                            Icon(Icons.credit_card, color: Color(0xFF3E84A8)),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) =>
                                PaymentDetailPage(), // Asumsi ada constructor yang menerima data
                          ),
                        );
                      },
                      child: Text(
